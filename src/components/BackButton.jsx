...
const BackButton = () =>{
    ...
    return(
        <div className="flex fixed top-2 left-3 z-30 py-2 px-3 gap-6 bg-slate-50 rounded-xl">
            <button className="cursor-pointer outline-none flex items-center bg-transparent" onClick={() => navigate("/pokemons")}>
                <div className="text-zinc-600 bg-slate-300 rounded-xl size-10 flex items-center justify-center">
