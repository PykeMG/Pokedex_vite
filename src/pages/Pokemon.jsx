...
const Pokemon = () =>{
    ...
    <BackButton />
        ...
        <div className={`${pokemon?.type} h-max`} >
        <main className="flex flex-col items-center h-full pt-20 max-w-[500px] my-0 relative w-full p-0 m-auto justify-between">
            ...
            <div className="w-full flex flex-col items-center py-0 px-8 mx-auto bg-slate-50 text-zinc-900 pt-14 rounded-t-3xl mt-[-40px]">
                ...
                <h2 className='text-zinc-950 pb-4 text-xl font-bold'>Stats</h2>
                    <Stats title='HP' stat={pokemon?.hp} type={pokemon?.type}/>
                    <Stats title='Attack' stat={pokemon?.attack} type={pokemon?.type}/>
                    <Stats title='Defense' stat={pokemon?.defense} type={pokemon?.type}/>
                    <Stats title='Speed' stat={pokemon?.speed} type={pokemon?.type}/>
                    <Stats title='Sp. Atk' stat={pokemon?.specialAttack} type={pokemon?.type}/>
                    <Stats title='Sp. Def' stat={pokemon?.specialDefense} type={pokemon?.type}/>
                </div>    
                ...
                <div className='w-full pb-8'>
                    <h2 className='text-zinc-950 pb-4 text-xl font-bold'>Moves</h2>
                    {pokemon.moves.map((moves, index) => (
                        <Move moves={moves} key={index}/>
                    ))}
                </div> 
            </div>
        </main>
